...
const RecommendAttraction = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess('Tourist attraction Recommendation added successfully!')
      ...
      >
        ...
        >
          <h2 className="text-3xl font-bold mb-6 text-gray-600">
            Give Recommendation for Attractions
          </h2>
          {error && (
...
export default RecommendAttraction
